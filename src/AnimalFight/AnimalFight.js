    ...
    <div className="fight">
      <div className="lion">
        ...
        <div className="buttons">
          <button className='center'>The lion is growing!</button>
          <button>The lion is munching down on the unicorn!</button>
        </div>
      </div>
      <div className="unicorn">
        <img src={'./images/unicorn.jpeg'} style={{ width: unicornSize * 10 }}></img>
        <div>
          <button className='center'>The unicorn is growing!</button>
          <button>The unicorn is munching down on the lion!</button>
        </div>
